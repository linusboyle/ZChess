...
QT_MOC_LITERAL(1, 17, 21), // "configurationSelected"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 11) // "onConfirmed"

    },
    "ConnectionDialog\0configurationSelected\0"
    "\0onConfirmed"
};
...
void ConnectionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->configurationSelected((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->onConfirmed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ConnectionDialog::*)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionDialog::configurationSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConnectionDialog::configurationSelected(QString _t1, int _t2)
{
